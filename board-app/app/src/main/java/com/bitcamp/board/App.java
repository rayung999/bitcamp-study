 ...
 * 비트캠프-20220704
 */
// 컴파일 : javac -encoding UTF-8 -d app/bin/main app/src/main/java/com/bitcamp/board/App.java
// 실행 : java -cp app/bin/main com.bitcamp.board.App
...
public class App {
  public static void main(String[] args) {
      ...
      if (menuNo == 0) {
        ...
        System.out.print("번호 제목 조회수 작성자 등록일");
